...
public class Moose extends NaturalistAnimal implements NeutralMob, NaturalistGeoEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return this.isBaby() ? NaturalistSoundEvents.MOOSE_AMBIENT_BABY.get() : NaturalistSoundEvents.MOOSE_AMBIENT.get();
    }

    @Override
    protected SoundEvent getHurtSound(@NotNull DamageSource damageSource) {
        return this.isBaby() ? NaturalistSoundEvents.MOOSE_HURT_BABY.get() : NaturalistSoundEvents.MOOSE_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return this.isBaby() ? NaturalistSoundEvents.MOOSE_DEATH_BABY.get() : NaturalistSoundEvents.MOOSE_DEATH.get();
    }
