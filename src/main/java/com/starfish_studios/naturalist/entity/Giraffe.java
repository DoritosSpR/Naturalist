...
public class Giraffe extends NaturalistAnimal implements NaturalistGeoEntity {
    ...
    protected void positionRider(@NotNull Entity passenger, @NotNull MoveFunction callback) {
        ...
        callback.accept(passenger, this.getX(), this.getY() + this.getPassengerAttachmentPoint(passenger, this.getDimensions(Pose.STANDING), this.getScale()).y, this.getZ());
    ...
    protected SoundEvent getHurtSound(@NotNull DamageSource damageSource) {
        return NaturalistSoundEvents.GIRAFFE_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return NaturalistSoundEvents.GIRAFFE_DEATH.get();
    }
