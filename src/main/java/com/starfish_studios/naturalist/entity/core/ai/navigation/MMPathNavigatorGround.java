package com.starfish_studios.naturalist.entity.core.ai.navigation;
        ...
        do {
            ...
            for (int x = x0; x != x1; x += stepx) {
                for (int z = z0; z != z1; z += stepz) {
                    ...
                    PathType below = WalkNodeEvaluator.getPathTypeStatic(this.mob, pos.set(x, y0 - 1, z));
                    if (below == PathType.WATER || below == PathType.LAVA || below == PathType.OPEN) return false;
                    PathType in = WalkNodeEvaluator.getPathTypeStatic(this.mob, pos.set(x, y0, z));
