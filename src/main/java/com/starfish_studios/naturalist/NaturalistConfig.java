...
public class NaturalistConfig extends MidnightConfig {
    ...
    @Comment(category = "mobRemoval")
    public static Comment mobRemoval;
    @Comment(category = "mobRemoval")
    public static Comment spacer;

    @Entry(category = "mobRemoval")
    ...
    @Comment(category = "mobConfig")
    public static Comment biomeConfig;
    @Comment(category = "mobConfig")
    public static Comment blacklistConfig;
    @Comment(category = "mobConfig")
    public static Comment spacer2;

    @Entry(category = "mobConfig")
    public static int alligatorSpawnWeight = 10;
    @Entry(category = "mobConfig", isSlider = true, min = 1, max = 8)
    ...
    @Entry(category = "mobConfig")
    public static boolean lionsAttackBabyHostiles = false;
    @Entry(category = "mobConfig")
