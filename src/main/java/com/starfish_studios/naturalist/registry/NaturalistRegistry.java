...
import com.starfish_studios.naturalist.item.BugNetItem;
...
import static com.starfish_studios.naturalist.registry.NaturalistRegistries.registerItem;
import static com.starfish_studios.naturalist.registry.NaturalistRegistries.registerMobBucketItem;
...
public class NaturalistRegistry {
    ...
    public static final Supplier<Item> GLOW_GOOP = NaturalistRegistries.registerItem("glow_goop", () -> new GlowGoopItem(GLOW_GOOP_BLOCK.get(), new Item.Properties()));
    ...
    public static final Supplier<Item> CATERPILLAR = NaturalistRegistries.registerCaughtMobItem("caterpillar", NaturalistEntityTypes.CATERPILLAR, () -> Fluids.EMPTY, NaturalistSoundEvents.SNAIL_FORWARD);
    public static final Supplier<Item> BUTTERFLY = NaturalistRegistries.registerCaughtMobItem("butterfly", NaturalistEntityTypes.BUTTERFLY, () -> Fluids.EMPTY, NaturalistSoundEvents.BIRD_FLY);
    public static final Supplier<Item> SNAIL_SHELL = registerItem("snail_shell", () -> new Item(new Item.Properties()));
    public static final Supplier<Item> SNAIL_BUCKET = NaturalistRegistries.registerNoFluidMobBucketItem("snail_bucket", NaturalistEntityTypes.SNAIL, () -> Fluids.EMPTY, NaturalistSoundEvents.BUCKET_EMPTY_SNAIL);
    ...
    //region SPAWN EGGS
    public static final Supplier<SpawnEggItem> ALLIGATOR_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("alligator_spawn_egg", NaturalistEntityTypes.ALLIGATOR, 6184228, 13810273);
    public static final Supplier<SpawnEggItem> BASS_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("bass_spawn_egg", NaturalistEntityTypes.BASS, 8159273, 14729339);
    public static final Supplier<SpawnEggItem> BEAR_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("bear_spawn_egg", NaturalistEntityTypes.BEAR, 6569255, 13150577);
    public static final Supplier<SpawnEggItem> BLUEJAY_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("bluejay_spawn_egg", NaturalistEntityTypes.BLUEJAY, 2830129, 4289464);
    public static final Supplier<SpawnEggItem> BOAR_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("boar_spawn_egg", NaturalistEntityTypes.BOAR, 6768433, 9854549);
    public static final Supplier<SpawnEggItem> BUTTERFLY_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("butterfly_spawn_egg", NaturalistEntityTypes.BUTTERFLY, 15165706, 6828564);
    public static final Supplier<SpawnEggItem> CANARY_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("canary_spawn_egg", NaturalistEntityTypes.CANARY, 16704333, 13999625);
    public static final Supplier<SpawnEggItem> CARDINAL_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("cardinal_spawn_egg", NaturalistEntityTypes.CARDINAL, 13772840, 4465186);
    public static final Supplier<SpawnEggItem> CATFISH_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("catfish_spawn_egg", NaturalistEntityTypes.CATFISH, 8416033, 12233092);
    public static final Supplier<SpawnEggItem> CATERPILLAR_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("caterpillar_spawn_egg", NaturalistEntityTypes.CATERPILLAR, 3815473, 15647488);
    public static final Supplier<SpawnEggItem> CORAL_SNAKE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("coral_snake_spawn_egg", NaturalistEntityTypes.CORAL_SNAKE, 3485226, 12261376);
    public static final Supplier<SpawnEggItem> DEER_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("deer_spawn_egg", NaturalistEntityTypes.DEER, 10318165, 14531208);
    public static final Supplier<SpawnEggItem> DRAGONFLY_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("dragonfly_spawn_egg", NaturalistEntityTypes.DRAGONFLY, 7507200, 16771840);
    public static final Supplier<SpawnEggItem> DUCK_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("duck_spawn_egg", NaturalistEntityTypes.DUCK, 13286315, 2333491);
    public static final Supplier<SpawnEggItem> ELEPHANT_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("elephant_spawn_egg", NaturalistEntityTypes.ELEPHANT, 9539213, 6643034);
    public static final Supplier<SpawnEggItem> FINCH_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("finch_spawn_egg", NaturalistEntityTypes.FINCH, 12013877, 6576975);
    public static final Supplier<SpawnEggItem> FIREFLY_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("firefly_spawn_egg", NaturalistEntityTypes.FIREFLY, 6764577, 16768800);
    public static final Supplier<SpawnEggItem> GIRAFFE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("giraffe_spawn_egg", NaturalistEntityTypes.GIRAFFE, 14329967, 7619616);
    public static final Supplier<SpawnEggItem> HIPPO_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("hippo_spawn_egg", NaturalistEntityTypes.HIPPO, 15702682, 9004386);
    public static final Supplier<SpawnEggItem> LION_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("lion_spawn_egg", NaturalistEntityTypes.LION, 14990722, 6699537);
    public static final Supplier<SpawnEggItem> LIZARD_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("lizard_spawn_egg", NaturalistEntityTypes.LIZARD, 10853166, 15724462);
    public static final Supplier<SpawnEggItem> RATTLESNAKE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("rattlesnake_spawn_egg", NaturalistEntityTypes.RATTLESNAKE, 16039772, 7293214);
    public static final Supplier<SpawnEggItem> RHINO_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("rhino_spawn_egg", NaturalistEntityTypes.RHINO, 7626842, 10982025);
    public static final Supplier<SpawnEggItem> ROBIN_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("robin_spawn_egg", NaturalistEntityTypes.ROBIN, 4865860, 16620592);
    public static final Supplier<SpawnEggItem> SNAKE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("snake_spawn_egg", NaturalistEntityTypes.SNAKE, 8813107, 15524255);
    public static final Supplier<SpawnEggItem> SNAIL_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("snail_spawn_egg", NaturalistEntityTypes.SNAIL, 5457209, 8811878);
    public static final Supplier<SpawnEggItem> SPARROW_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("sparrow_spawn_egg", NaturalistEntityTypes.SPARROW, 6504493, 14603707);
    public static final Supplier<SpawnEggItem> TORTOISE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("tortoise_spawn_egg", NaturalistEntityTypes.TORTOISE, 15724462, 11765582);
    public static final Supplier<SpawnEggItem> VULTURE_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("vulture_spawn_egg", NaturalistEntityTypes.VULTURE, 4010022, 15325376);
    public static final Supplier<SpawnEggItem> ZEBRA_SPAWN_EGG = NaturalistRegistries.registerSpawnEggItem("zebra_spawn_egg", NaturalistEntityTypes.ZEBRA, 15263457, 1710104);
    ...
    public static <T extends Block> Supplier<T> registerBlock(String name, Supplier<T> block) {
        Supplier<T> supplier = NaturalistRegistries.registerBlock(name, block);
    ...
    public static <T extends Block> Supplier<T> registerBlockOnly(String name, Supplier<T> block) {
        return NaturalistRegistries.registerBlock(name, block);
    }
}
