...
public class AddAnimalsBiomeModifier implements BiomeModifier {
    ...
    public void modify(@NotNull Holder<Biome> biome, Phase phase, ModifiableBiomeInfo.BiomeInfo.@NotNull Builder builder) {
        if (phase.equals(Phase.ADD)) {
            /* ALLIGATOR */
            if (NaturalistConfig.alligatorSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_ALLIGATOR))
            ...
            /* BASS */
            if (NaturalistConfig.bassSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_BASS))
            ...
            /* BEAR */
            if (NaturalistConfig.bearSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_BEAR))
            ...
            /* BLUEJAY */
            if (NaturalistConfig.bluejaySpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_BLUEJAY))
            ...
            /* BOAR */
            if (NaturalistConfig.boarSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_BOAR))
            ...
            /* BUTTERFLY */
            if (NaturalistConfig.butterflySpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_BUTTERFLY))
            ...
            /* CANARY */
            if (NaturalistConfig.canarySpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_CANARY))
            ...
            /* CARDINAL */
            if (NaturalistConfig.cardinalSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_CARDINAL))
            ...
            /* CATFISH */
            if (NaturalistConfig.catfishSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_CATFISH))
            ...
            /* CORAL_SNAKE */
            if (NaturalistConfig.coralSnakeSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_CORAL_SNAKE))
            ...
            /* DEER */
            if (NaturalistConfig.deerSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_DEER))
            ...
            /* DRAGONFLY */
            if (NaturalistConfig.dragonflySpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_DRAGONFLY))
            ...
            /* DUCK */
            if (NaturalistConfig.duckSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_DUCK))
            ...
            /* ELEPHANT */
            if (NaturalistConfig.elephantSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_ELEPHANT))
            ...
            /* FINCH */
            if (NaturalistConfig.finchSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_FINCH))
            ...
            /* FIREFLY */
            if (NaturalistConfig.fireflySpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_FIREFLY))
            ...
            /* GIRAFFE */
            if (NaturalistConfig.giraffeSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_GIRAFFE))
            ...
            /* HIPPO */
            if (NaturalistConfig.hippoSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_HIPPO))
            ...
            /* LION */
            if (NaturalistConfig.lionSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_LION))
            ...
            /* LIZARD */
            if (NaturalistConfig.lizardSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_LIZARD))
            ...
            /* RHINO */
            if (NaturalistConfig.rhinoSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_RHINO))
            ...
            /* ROBIN */
            if (NaturalistConfig.robinSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_ROBIN))
            ...
            /* SNAIL */
            if (NaturalistConfig.snailSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_SNAIL))
            ...
            /* SNAKE */
            if (NaturalistConfig.snakeSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_SNAKE))
            ...
            /* SPARROW */
            if (NaturalistConfig.sparrowSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_SPARROW))
            ...
            /* TORTOISE */
            if (NaturalistConfig.tortoiseSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_TORTOISE))
            ...
            /* VULTURE */
            if (NaturalistConfig.vultureSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_VULTURE))
            ...
            /* ZEBRA */
            if (NaturalistConfig.zebraSpawnWeight != 0 && !biome.is(NaturalistTags.Biomes.BLACKLIST_ZEBRA))
